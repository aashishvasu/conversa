...
lookup_tool = ConversaTool("lookup", "Look up items.", LookupArguments, lookup)
...
unavailable_tool = ConversaTool("unavailable", "Look up unavailable items.", LookupArguments, unavailable)
...
rejected_tool = ConversaTool("rejected", "Reject a lookup.", LookupArguments, rejected)
...
try:
    ...
    ConversaTool("loose", "Loose arguments.", LooseArguments, lookup)
